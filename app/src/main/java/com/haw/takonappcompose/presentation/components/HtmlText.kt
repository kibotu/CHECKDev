 ...
 * Taken from https://github.com/ch4rl3x/HtmlText/blob/main/html-text/src/main/java/de/charlex/compose/HtmlText.kt
 *
 * Supported are:
 *
 * &lt;b>Bold&lt;/b>
 ...
 *
 * &lt;span style=\"color: #65b900\">green text&lt;/style>
 *
...
fun HtmlText(
    ...
    onSpannedTextClicked: (String, UriHandler) -> Unit = { link, uriHandler -> uriHandler.openUri(link) }
) {
    ...
    HtmlText(
        ...
        style = style,
        onSpannedTextClicked = onSpannedTextClicked
    )
}
...
fun HtmlText(
    ...
    val annotatedString = text.html.toAnnotatedString(urlSpanStyle, colorMapping)
                                ...
                                annotatedString
                                    ...
                                    ?.let { sa ->
                                        if (sa.tag == "url") { // NON-NLS
                                            onSpannedTextClicked(sa.item, uriHandler)
                                        }
                                    }
                            }
                        })
